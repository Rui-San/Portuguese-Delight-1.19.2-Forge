...
public class ModFoods {
    ...
    public static final FoodProperties FRANCESINHA = (new FoodProperties.Builder()).nutrition(10).saturationMod(0.9F).build();
    public static final FoodProperties TRIPES = (new FoodProperties.Builder()).nutrition(2).saturationMod(0.3F).effect(new MobEffectInstance(MobEffects.HUNGER, 600, 0), 1.0F).meat().build();
